...
const profileName = "Jeetesh Meena";
          ...
          {page === "detail" ? (
            <SubpageShell title="" onBack={closePage}>
              <div className="-mt-6 flex flex-col items-center">
                ...
                <h2 className="mt-3 text-[22px] font-semibold">{profileName}</h2>
              </div>
              ...
              <div className="mt-6 rounded-2xl bg-secondary px-5">
                <div className="grid min-h-[58px] grid-cols-[minmax(0,1fr)_auto] items-center gap-3 border-b border-border">
                  ...
                  <span className="flex items-center gap-2 text-[15px]">
                    {profileUid}
                    <button type="button" aria-label="Copy UID" onClick={copyUid} className="text-foreground">
            ...
            <div className="flex min-h-[calc(100dvh-26px)] flex-col">
              ...
              >
                <img
                  ...
                  width={816}
                  height={816}
                  className="size-14 rounded-full bg-[#b9a8d9] object-cover"
                />
                <span className="min-w-0">
                  ...
                  <span className="mt-1.5 flex gap-2">
                    <span className="rounded-md bg-[#0f2f1d] px-2.5 py-1 text-[12px] font-medium text-[#4ade80]">New</span>
                    <span className="rounded-md bg-[#0f2f1d] px-2.5 py-1 text-[12px] font-medium text-[#4ade80]">Premium</span>
                  </span>
                </span>
              ...
              <button
                type="button"
                onClick={() => showToast("Coming Soon")}
                className="mt-5 flex w-full items-center gap-4 rounded-2xl border border-border bg-secondary p-4 text-left transition-colors hover:bg-accent"
              >
                <span className="grid size-11 shrink-0 place-items-center rounded-xl bg-[#e23b3b]">
                  <Users className="size-6 text-white" strokeWidth={1.9} />
                </span>
                <span className="min-w-0 flex-1">
                  <span className="block text-[16px] font-semibold">Referral</span>
                  <span className="mt-0.5 block text-[13px] leading-snug text-muted-foreground">
                    Earn up to 40% commission by inviting friends
                  </span>
                </span>
                <span className="grid h-10 shrink-0 place-items-center rounded-full bg-canvas px-4 text-[14px] font-medium">
                  Invite now
                </span>
              </button>
